...
implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Intent.ACTION_SEND.equals(action) && type != null) {
            if ("text/plain".equals(type)) {
                etInput.setText(intent.getStringExtra(Intent.EXTRA_TEXT));
            }
        }
    }
    ...
    private void createStartButton() {
        startButton = (Button) findViewById(resId("id", "start"));
    ...
    private void createList() {
        urlInput = (ListView) findViewById(resId("id", "urlInput"));
        clipButton = (Button) findViewById(resId("id", "clipboard"));
        clearButton = (Button) findViewById(resId("id", "clear"));

        final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>
                (this, android.R.layout.simple_list_item_1, url_list);

        urlInput.setAdapter(arrayAdapter);
        ...
        clipButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (clip.getText().toString() != null && !clip.getText().toString().equals(""))
                    url_list.add(clip.getText().toString());
                arrayAdapter.notifyDataSetChanged();
            }
        });
    }
