...
def _real_main(arguments, argv=None):
    ...
    parser, opts, args = parseOpts(arguments, argv)
    ...
    with YoutubeDL(ydl_opts) as ydl:
        ...
        if not actual_use:
            ...
            ydl.warn_if_short_id(arguments[1:] if arguments is None else arguments)
            parser.error(
...
def main(arguments, argv=None):
    try:
        _real_main(arguments, argv)
